...
// In other words, if you have both messages "Enjoy!" and "Too much!" showing up at the same time, it's an error.
//
...
(function () {
  ...
  function LunchCheckController($scope) {
    ...
    $scope.checkTooMuch = function(){
      var i = count($scope.menu);
      if (i == 0){
        $scope.message = "Please enter data first";
        $scope.msg_style = "color:red; border: 2px solid red;";
      } else if(i < 4){
        $scope.message = "Enjoy!";
        $scope.msg_style = "color:green; border: 2px solid green;";
      } else {
